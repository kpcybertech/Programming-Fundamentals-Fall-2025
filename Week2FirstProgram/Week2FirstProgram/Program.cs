...
namespace Week2FirstProgram
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string tomorrowWeather = "rainy";
            Console.WriteLine($"The weather today is {weatherToday}), tomorrow will be {tomorrowWeather}.");

            // STEP 10: You can output the number of letters in a string using the Length property

            Console.WriteLine($"'{weatherToday}' has {weatherToday.Length} letters");

            // STEP 11: Create a string variable for a sentence with spaces at the start and end

            string sentenceWithspaces = "       It is windy outside     ";
            

            // STEP 12: Output the above string variable to the console with square brackets around it

            Console.WriteLine($"{sentenceWithSpaces}");
            ...
            string trimmedSentence = sentenceWithSpaces.Trim();
            ...
            Console.WriteLine($" Contains 'snowy'? {snowySentence.Contains("snowy")}");

            // STEP 19: Update the above to look for "rainy" instead

            Console.WriteLine($" Contains 'snowy'? {snowySentence.Contains("windy")}");
